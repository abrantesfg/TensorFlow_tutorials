...
#Scale values to a range of 0 to 1 before feeding to the neural network model
...
#Flatten: transforms the format of the images from a two-dimensional
#         array (of 28 by 28 pixels) to a one-dimensional array
#         (of 28 * 28 = 784 pixels)
#Dense: densely connected, or fully connected, neural layers. Parameter = number of nodes
